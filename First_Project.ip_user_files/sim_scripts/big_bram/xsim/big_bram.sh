...
#
# Script generated by Vivado on Fri Feb 21 13:35:52 -0800 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : big_bram.sh
...
#
# Usage        : big_bram.sh
#                big_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                big_bram.sh [-reset_run]
#                big_bram.sh [-reset_log]
#                big_bram.sh [-help]
#
...
# script info
echo -e "big_bram.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./big_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot big_bram xil_defaultlib.big_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim big_bram -key {Behavioral:sim_1:Functional:big_bram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb big_bram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./big_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: big_bram.sh [-help]\n\
Usage: big_bram.sh [-step]\n\
Usage: big_bram.sh [-lib_map_path]\n\
Usage: big_bram.sh [-reset_run]\n\
Usage: big_bram.sh [-reset_log]\n\
Usage: big_bram.sh [-keep_index]\n\
Usage: big_bram.sh [-noclean_files]\n\n\
