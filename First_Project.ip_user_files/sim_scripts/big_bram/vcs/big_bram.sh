...
#                script (type 'big_bram.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.big_bram xil_defaultlib.glbl -o big_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./big_bram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key big_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc big_bram_simv.daidir vcs_lib c.obj)
