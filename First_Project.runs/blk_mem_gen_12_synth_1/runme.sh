...
HD_PWD='C:/Users/arg/Documents/GitHub/FPGA/First_Project/First_Project.runs/blk_mem_gen_12_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_12.tcl
