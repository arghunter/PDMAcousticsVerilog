...
set genomeRtd $env(RT_TMP)/1BC08B82940.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {cic_array__GB14}]"
...
set genomeName [subst -nocommands -novariables {cic_array__GB14}]
