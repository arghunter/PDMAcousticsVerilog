...
HD_PWD='C:/Users/arg/Documents/GitHub/FPGA/First_Project/First_Project.runs/big_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log big_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source big_bram.tcl
