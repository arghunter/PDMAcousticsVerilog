...
HD_PWD='C:/Users/arg/Documents/GitHub/FPGA/First_Project/First_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_io.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_io.tcl -notrace
